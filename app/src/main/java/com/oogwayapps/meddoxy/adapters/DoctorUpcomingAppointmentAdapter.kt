...
class DoctorUpcomingAppointmentAdapter(private val onclick:(AppointmentDetails)->Unit):RecyclerView.Adapter<DoctorUpcomingAppointmentAdapter.DoctorUpcomingAppointmentAdapterViewHolder>()
{
    inner class DoctorUpcomingAppointmentAdapterViewHolder(val binding: ItemDoctorUpcomingAppointmentBinding):RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DoctorUpcomingAppointmentAdapterViewHolder {
        val binding = ItemDoctorUpcomingAppointmentBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: DoctorUpcomingAppointmentAdapterViewHolder, position: Int) {
        ...
        holder.binding.consulatationOver.setOnClickListener {
            onclick(appointment)
        }
